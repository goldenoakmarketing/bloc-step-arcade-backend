...
export class PlayerRepository {
  ...
  private mapToPlayer(data: {
    ...
    return {
      ...
      cachedTimeBalance: BigInt(data.cached_time_balance),
      cachedStakedBalance: BigInt(data.cached_staked_balance),
      totalTimePurchased: BigInt(data.total_time_purchased),
      totalTimeConsumed: BigInt(data.total_time_consumed),
      totalYeeted: BigInt(data.total_yeeted),
      totalTipsSent: BigInt(data.total_tips_sent),
      totalTipsReceived: BigInt(data.total_tips_received),
